  ...
  return (
    <li className="p-4 hover:bg-gray-50 dark:hover:bg-gray-800/50">
      <div className="grid grid-cols-12 gap-4">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-grow">
              <div className="flex items-center gap-2 flex-wrap mb-1">
                <Link
                  to={`/members/forum/${categorySlug}/${topic.slug}`}
        ...
        <div className="col-span-12 md:col-span-4 lg:col-span-3 flex items-center justify-end md:justify-center mt-2 md:mt-0">
