          ...
          {personalities?.map((personality, index) => (
            ...
            >
              ...
              <div className="p-8">
                ...
                {personality.show_times && (
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                    {personality.show_times.days.join(", ")} • {personality.show_times.start} - {personality.show_times.end}
                  </p>
                )}
                  ...
                  {personality.social_links && (
                    <div className="flex space-x-4">
                      {personality.social_links.twitter && (
                        <a href={personality.social_links.twitter} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#1DA1F2]">
                      ...
                      {personality.social_links.instagram && (
                        <a href={personality.social_links.instagram} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#E4405F]">
                          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      ...
                      {personality.social_links.facebook && (
                        <a href={personality.social_links.facebook} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#1877F2]">
                          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
