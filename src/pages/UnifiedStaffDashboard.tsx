    ...
    return (
      <div className="flex items-center justify-center h-[calc(100vh-128px)]">
        <div className="text-center">
          ...
          <p className="text-lg text-muted-foreground">Loading Unified Dashboard...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 sm:mb-8 gap-4">
          ...
          <div className="text-center sm:text-right order-1 sm:order-2 w-full sm:w-auto">
            <h1 className="text-2xl sm:text-3xl font-bold flex items-center gap-2 justify-center sm:justify-end">
              ...
              <span className="break-words">Unified Dashboard</span>
            </h1>
            <p className="text-muted-foreground mt-1 text-sm sm:text-base">
              Access all management tools from one unified interface.
            </p>
          </div>
        </div>
        ...
        <Card className="border-primary/50 bg-primary/5 dark:bg-primary/10">
          <CardHeader className="pb-3">
            <CardTitle className="flex items-center gap-2 text-primary text-lg sm:text-xl">
              ...
              <span className="break-words">Centralized Management</span>
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <p className="text-foreground/80 text-sm sm:text-base leading-relaxed">
              All staff management features are now integrated into one 
              unified dashboard. This includes content management, user administration, 
